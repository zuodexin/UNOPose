"""visulization of optical flow (optflow)"""
...
from .image import imshow  # cv2 imshow
import matplotlib.pyplot as plt


def flowshow(flow, win_name="", wait_time=0, vis_tool="matplotlib"):
    """Show optical flow.
...
def flow2rgb(flow, color_wheel=None, unknown_thr=1e6):
    # NOTE: the same as flowlib.get_flow_show(flow, mode='Y')
