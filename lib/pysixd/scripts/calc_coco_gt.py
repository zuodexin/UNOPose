...
from lib.pysixd import pycoco_utils
...
for scene_id in dp_split["scene_ids"]:
    ...
    coco_scene_output = {"info": INFO, "licenses": [], "categories": CATEGORIES, "images": [], "annotations": []}
    ...
    for scene_view, inst_list in scene_gt.items():
        ...
        for idx, inst in enumerate(inst_list):
            ...
            binary_inst_mask = (inout.load_depth(mask_p) / 255.0).astype(np.bool_)
