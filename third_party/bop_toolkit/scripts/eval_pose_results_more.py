...
p = {
    ...
    # https://bop.felk.cvut.cz/media/data/bop_sample_results/bop_challenge_2019_sample_results.
...
parser.add_argument(
    "--targets_filename",
    default=p["targets_filename"],
    help="path of gt targets",
)
parser.add_argument(
    "--error_types",
    default=",".join(["mspd", "mssd", "vsd", "reteS", "add", "adi", "teS", "reS", "projS"]),
