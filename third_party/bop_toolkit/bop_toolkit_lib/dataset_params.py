...
def get_split_params(datasets_path, dataset_name, split, split_type=None):
    ...
    # T-LESS.
        ...
        p["im_size"] = {
            ...
            "test": {"primesense": (720, 540), "kinect": (720, 540), "canon": (2560, 1920)},
        }[split][split_type]
    ...
    # 'hb' -- Full HB dataset.
        ...
        if dataset_name_orig == "hbs":
            ...
            p["scene_ids"] = {"train": [], "val": list(range(1, 14)), "test": list(range(1, 14))}[split]

        p["im_size"] = {"pbr": (640, 480), "primesense": (640, 480), "kinect": (1920, 1080)}[split_type]
    ...
    # HOPE.
        ...
        p["scene_ids"] = {"train": [], "val": list(range(1, 11)), "test": list(range(1, 41))}[split]
        p["im_size"] = (1920, 1080)
