...
class PointnetFPModule(nn.Module):
    ...
    def forward(self, unknown, known, unknow_feats, known_feats):
        ...
        if known is not None:
            ...
            interpolated_feats = pointnet2_utils.three_interpolate(known_feats, idx.detach(), weight.detach())
        else:
...
if __name__ == "__main__":
    ...
    test_module = PointnetSAModuleMSG(npoint=2, radii=[5.0, 10.0], nsamples=[6, 3], mlps=[[9, 3], [9, 6]])
    test_module.cuda()
